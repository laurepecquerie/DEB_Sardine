...
function [Prd_data, info] = predict_Sardina_pilchardus(par, chem, T_ref, data)
  ...
  a = [-1e-10;tL_juv1(:,1)];
  [a ELH] = ode45(@dget_ELH, a, [E_0 1e-10 0], [], L_b,  L_m, pT_Am, vT, g, kT_J, kap, f, E_Hb); 
...
%   EL_ad_m = L/ del_M;
  ...
  [t ELHR] = ode45(@dget_ELHR, tE(:,1), [E_init L_init E_Hp 0], [], L_b, L_m, p_Am, v, g, k_J, kap, E_Hb, E_Hp, T_A, T_ref); 
...
%   Prd_data.tL_ad_m = EL_ad_m;
  ...
  function dELH = dget_ELH(t, ELH, Lb, Lm, p_Am, v, g, k_J, kap, f, Hb)
  ...
  function dELHR = dget_ELHR(t, ELHR, Lb, Lm, p_Am, v, g, k_J, kap, Hb, Hp, T_A, T_ref)
  %% change in state variables during juvenile stage
