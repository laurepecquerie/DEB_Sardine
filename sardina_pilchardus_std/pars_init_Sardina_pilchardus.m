...
par.kap = 0.8;      free.kap   = 0;    units.kap = '-';        label.kap = 'kap';      % allocation fraction to soma
...
par.del_M = 0.18;    free.del_M = 1;    units.del_M = '-';      label.del_M = 'del_M';  % shape coefficient - adult - total length
par.del_Mb = 0.11;   free.del_Mb = 1;   units.del_Mb = '-';     label.del_Mb = 'del_Mb';  % shape coefficient - larvae at birth - standard length
