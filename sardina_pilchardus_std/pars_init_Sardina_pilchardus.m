...
par.del_M = 0.17;    free.del_M = 0;    units.del_M = '-';      label.del_M = 'del_M';  % shape coefficient - adult - total length
par.del_Mb = 0.11;   free.del_Mb = 0;   units.del_Mb = '-';     label.del_Mb = 'del_Mb';  % shape coefficient - larvae at birth - standard length

% environmental parameters (temperatures are in data)
par.f = 0.9;             free.f     = 0;       units.f = '-';           label.f = 'f';          % scaled functional response for 0-var data
...
n_O = [1.00, 1.00, 1.00, 1.00;  % C/C, equals 1 by definition
       1.80, 1.80, 2,  1.80;  % H/C  these values show that we consider dry-mass
       0.50, 0.55, 0.6,  0.50;  % O/C
