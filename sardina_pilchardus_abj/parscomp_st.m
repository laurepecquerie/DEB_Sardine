...
w       = E_m * w_E / p.d_E/ p.mu_E; % -, \omega, contribution of ash free dry mass of reserve to total ash free dry biomass
J_E_Am  = p_Am/ p.mu_E;          % mol/d.cm^2, {J_EAm}, max surface-spec assimilation flux

muw_E   = p.mu_E / w_E;          % J / g dw, energy content per g dry weight of reserve
muw_V   = p.mu_V / w_V;          % J / g dw, energy content per g dry weight of structure
...
cPar = struct('p_Am', p_Am, 'w_X', w_X, 'w_V', w_V, 'w_E', w_E, 'w_P', w_P, 'M_V', M_V, 'y_V_E', y_V_E, 'y_E_V', y_E_V, ...
              ...
              'J_E_Am', J_E_Am, 'J_E_M', J_E_M, 'J_E_T', J_E_T, 'j_E_M', j_E_M, 'j_E_J', j_E_J, 'kap_G', kap_G, 'E_V', E_V, 'n_O', n_O, 'n_M', n_M, 'muw_E', muw_E, 'muw_V', muw_V);
