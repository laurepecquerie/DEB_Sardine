...
par.z     = 0.5;       free.z     = 0;   units.z     = '-';        label.z     = 'zoom factor'; %for z = 1: L_m = 1 cm
par.F_m   = 6.5;       free.F_m   = 0;   units.F_m   = 'l/d.cm^2'; label.F_m   = '{F_m}, max spec searching rate';
par.kap_X = 0.8;       free.kap_X = 0;   units.kap_X = '-';        label.kap_X = 'digestion efficiency of food to reserve';
par.kap_P = 0.1;       free.kap_P = 0;   units.kap_P = '-';        label.kap_P = 'faecation efficiency of food to faeces';
par.v     = 0.11;      free.v     = 0;   units.v     = 'cm/d';     label.v     = 'energy conductance';
par.kap   = 0.7;       free.kap   = 0;   units.kap   = '-';        label.kap   = 'allocation fraction to soma';
par.kap_R = 0.95;      free.kap_R = 0;   units.kap_R = '-';        label.kap_R = 'reproduction efficiency';
par.p_M   = 92.51;     free.p_M   = 0;   units.p_M   = 'J/d.cm^3'; label.p_M   = '[p_M], vol-spec somatic maint';
...
par.E_Hb  = 0.5 * 1.372e0;   free.E_Hb  = 0;   units.E_Hb  = 'J';        label.E_Hb  = 'maturity at birth';
par.E_Hj  = 30*1.944e1;   free.E_Hj  = 0;    units.E_Hj = 'J';         label.E_Hj  = 'maturity at metamorphosis';
par.E_Hp  = 0.1* 1.928e5;   free.E_Hp  = 0;   units.E_Hp  = 'J';        label.E_Hp  = 'maturity at puberty';
par.h_a   = 1.184e-8;  free.h_a   = 0;   units.h_a   = '1/d^2';    label.h_a   = 'Weibull aging acceleration';
...
par.f_tL_larv = 0.9;   free.f_tL_larv  = 0;  units.f_tL_larv = '-';   label.f_tL_larv = 'scaled functional response for larvae';    % scaled functional response for 1-var data
...
par.d_V = 0.20;      free.d_V   = 1;
par.mu_E = 600e3;    free.mu_E  = 1;   
par.mu_V = 470e3;    free.mu_V  = 1;
